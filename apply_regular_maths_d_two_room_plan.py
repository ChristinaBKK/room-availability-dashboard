#!/usr/bin/env python3
"""Apply the approved two-room plan for Regular Maths D."""
...
COURSE = "Regular Maths D"
TEACHER = "Joy Farhat"
BOOKING_ROWS = [
    {"date": "2026/06/10", "start_time": "10:00", "end_time": "11:25", "room": "B3042"},
    {"date": "2026/06/11", "start_time": "10:00", "end_time": "11:25", "room": "B3039"},
    {"date": "2026/06/12", "start_time": "11:30", "end_time": "12:10", "room": "B3042"},
    {"date": "2026/06/15", "start_time": "11:30", "end_time": "12:10", "room": "B3042"},
    {"date": "2026/06/16", "start_time": "14:35", "end_time": "16:00", "room": "B3042"},
    {"date": "2026/06/17", "start_time": "10:00", "end_time": "11:25", "room": "B3042"},
    {"date": "2026/06/18", "start_time": "10:00", "end_time": "11:25", "room": "B3039"},
    {"date": "2026/06/29", "start_time": "11:30", "end_time": "12:10", "room": "B3042"},
]
...
def main() -> int:
    ...
    print(json.dumps({"course": COURSE, "teacher": TEACHER, "cleared": cleared, **result}, indent=2))
    return 0
