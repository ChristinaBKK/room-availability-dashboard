// Database setup SQL kept separate from application logic.
window.AppSetup = {
    SETUP_SQL: `-- Create schedule table
...
-- Normalize room aliases so the trigger treats the same physical room identically
...
-- Reject any booking that overlaps an existing booking, class, or exam in the same room
